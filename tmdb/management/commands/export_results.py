    ...
    def download_results(self):
        ...
        for division in self.divisions:
            ...
            final = SparringTeamMatch.objects.filter(
                    division=division, round_num=0)[0]
            semis = SparringTeamMatch.objects.filter(
                    division=division, round_num=1)
            quarters = SparringTeamMatch.objects.filter(
                    division=division, round_num=2)
